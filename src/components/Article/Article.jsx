...
export function Article() {
    ...
    return (
        <div  className={styles.container} >
            <div  className={styles.article_return_container}>
                <Link to="/posts/" className={styles.article_return}>
                    Get me back
                </Link>
            </div>

            <img className={styles.article_bigpic_img} alt={article.name} src={article.img}></img>
